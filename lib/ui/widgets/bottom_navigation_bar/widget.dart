...
class CustomBottomNavigationBar extends StyleWidget<BottomNavigationBarSpec> {
  ...
  const CustomBottomNavigationBar({
    ...
    this.onTap,
    super.style = const BottomNavigationBarStyler.create(),
    this.variant,
    super.key,
  });

  @override
  Widget build(BuildContext context, BottomNavigationBarSpec spec) {
