...
class AppbarStyler extends Style<AppbarSpec>
  ...
  AppbarStyler({
    ...
    $automaticallyImplyLeading = Prop.value(automaticallyImplyLeading ?? true),
    $elevation = elevation == null ? null : Prop.value(elevation),
    $scrolledUnderElevation = scrolledUnderElevation == null ? null : Prop.value(scrolledUnderElevation),
    ...
    $foregroundColor = foregroundColor == null ? null : Prop.value(foregroundColor),
    $iconTheme = iconTheme == null ? null : Prop.value(iconTheme),
    $actionsIconTheme = actionsIconTheme == null ? null : Prop.value(actionsIconTheme),
    $primary = Prop.value(primary ?? true),
    $centerTitle = centerTitle == null ? null : Prop.value(centerTitle),
    $excludeHeaderSemantics = Prop.value(excludeHeaderSemantics ?? false),
    $titleSpacing = titleSpacing == null ? null : Prop.value(titleSpacing),
    $toolbarOpacity = Prop.value(toolbarOpacity ?? 1.0),
    $bottomOpacity = Prop.value(bottomOpacity ?? 1.0),
    $toolbarHeight = toolbarHeight == null ? null : Prop.value(toolbarHeight),
    $leadingWidth = leadingWidth == null ? null : Prop.value(leadingWidth),
    $toolbarTextStyle = toolbarTextStyle == null ? null : Prop.value(toolbarTextStyle),
    $titleTextStyle = titleTextStyle == null ? null : Prop.value(titleTextStyle),
    $systemOverlayStyle = systemOverlayStyle == null ? null : Prop.value(systemOverlayStyle),
    $forceMaterialTransparency = Prop.value(forceMaterialTransparency ?? false),
